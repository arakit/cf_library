...
public class LibFileManager {
	...
	public static File getPublicDownloadDir(){
		...
		LibUtil.Log("file = "+dir.getAbsolutePath());
		return dir;
	}	
...
//		File root = new File(sd.getAbsolutePath(),"CF_SOUND_ANALYZER");
...
//	private static String FORMAT_SOUND_RECORED_FILENAME = 
//			"%04d-%02d-%02d-%02d%02d%02d-%03d%s";
//	public static File getSoundRecordFile(File dir,Date date,String ext){
//		//File dir = getSoundDir();
//		if(dir==null) return null;
//		Calendar cal = Calendar.getInstance();
//		cal.setTime(date);
//		return new File(dir,String.format(FORMAT_SOUND_RECORED_FILENAME, 
